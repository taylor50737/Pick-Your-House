  ...
  <form @submit.prevent="create">
    <div class="grid grid-cols-6 gap-4">
      ...
      <div class="col-span-4">
        ...
        <input v-model.number="form.city" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
      ...
      <div class="col-span-2">
        ...
        <input v-model.number="form.code" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
      ...
      <div class="col-span-4">
        ...
        <input v-model.number="form.street" type="text" class="block w-full p-2 rounded-md shadow-sm border border-gray-300 dark:border-gray-600 text-gray-500" />
